...
public class RefillStation : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        // FIX: önce child'larda ara, bulunamazsa aynı GameObject'te dene
        playerWeapon = other.GetComponentInChildren<HarpoonWeapon>();
        if (playerWeapon == null)
            playerWeapon = other.GetComponent<HarpoonWeapon>();
